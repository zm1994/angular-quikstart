...
if (crypto) {
    var nativeRandomBytes = crypto.randomBytes;
    ...
    var nativePbkdf2 = crypto.pbkdf2;
    crypto.pbkdf2 = function pbkdf2Zone() {
        ...
        if (typeof fn === 'function') {
            ...
            return nativePbkdf2.apply(void 0, args);
        }
        else {
            return nativePbkdf2.apply(void 0, args);
        }
...
if (httpClient && httpClient.ClientRequest) {
    var ClientRequest = httpClient.ClientRequest.bind(httpClient);
